...
// BLE Mouse Class
class BLEMouse: public BLEHIDUtils, public BLECharacteristicCallbacks{
public:
...
// BLE Keyboard Class
class BLEKeyboard : public BLEHIDUtils, public BLECharacteristicCallbacks, public Print {  
public:
